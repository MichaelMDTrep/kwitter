...
overall this project gave us some great learning oppertunities
and it was essential to our understanding of react, redux, routing, api calls
as well as other digital and non-digital skill sets. we're grateful for the
team. matt, marcus and mike all were essential to the process, thanks.
the site works and we delevered it on time, but we could use improvement as a team in these areas such as
making reasonable deadlines, and meeting our individual targets so other team members can focus on their work like not taking on more work then we can handle individually.
and helping teammates who need help.
We could have taken the time to fully understand the starter code to maintain orginizational opinions and consistant formatting.
Getting help in a timely way would have made getting stuff done more effective. We could have been prepared at the begining of the project to start working.
meeting all the criterea.
We struggled to communicate issues we were having with our individual components
and had to redo a few of them costing us time. The breakdown of scheduling caused
styling and advanced features to be incompleted because regular feature weren't
done on time and we had to go back in the final hours as a group to complete them.
